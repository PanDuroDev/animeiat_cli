...
1. **Given** a user runs `animeiat-cli search "One Piece"`, **When** the refactored code processes the search, **Then** results match pre-refactor output in both JSON and TUI modes.
