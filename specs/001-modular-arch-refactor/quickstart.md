...
animeiat-cli search "One Piece" --json > baseline_search.json
animeiat-cli --help > baseline_help.txt

# After each layer extraction, compare output
animeiat-cli search "One Piece" --json > refactored_search.json
diff baseline_search.json refactored_search.json
# Expected: no differences

animeiat-cli --help > refactored_help.txt
